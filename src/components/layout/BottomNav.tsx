...
import { LayoutDashboard, Calendar, Wallet, Activity } from 'lucide-react';
        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-1.5 px-4 py-2 rounded-full transition-all duration-150 active:scale-95 ${
                isActive
